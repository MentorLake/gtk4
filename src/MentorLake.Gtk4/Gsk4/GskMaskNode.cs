...
public static class GskMaskNodeSignals
{
}

public static class GskMaskNodeHandleExtensions
{
	public static GskRenderNodeHandle GetMask(this GskRenderNodeHandle node)
	{
		return GskMaskNodeExterns.gsk_mask_node_get_mask(node);
	}

	public static GskMaskMode GetMaskMode(this GskRenderNodeHandle node)
	{
		return GskMaskNodeExterns.gsk_mask_node_get_mask_mode(node);
	}

	public static GskRenderNodeHandle GetSource(this GskRenderNodeHandle node)
	{
