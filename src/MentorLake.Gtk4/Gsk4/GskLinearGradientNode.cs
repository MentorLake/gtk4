...
public static class GskLinearGradientNodeSignals
{
}
...
public static class GskLinearGradientNodeHandleExtensions
{
	...
	public static graphene_point_tHandle GetEnd(this GskRenderNodeHandle node)
	{
	...
	public static graphene_point_tHandle GetStart(this GskRenderNodeHandle node)
	{
