...
public static class GskRadialGradientNodeSignals
{
}
...
public static class GskRadialGradientNodeHandleExtensions
{
	...
	public static float GetEnd(this GskRenderNodeHandle node)
	{
		return GskRadialGradientNodeExterns.gsk_radial_gradient_node_get_end(node);
	}

	public static float GetHradius(this GskRenderNodeHandle node)
	{
	...
	public static float GetStart(this GskRenderNodeHandle node)
	{
		return GskRadialGradientNodeExterns.gsk_radial_gradient_node_get_start(node);
	}

	public static float GetVradius(this GskRenderNodeHandle node)
	{
