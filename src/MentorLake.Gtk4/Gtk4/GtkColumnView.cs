...
public static class GtkColumnViewSignalExtensions
{
	...
	public static IObservable<GtkColumnViewSignalStructs.ActivateSignal> Signal_Activate(this GtkColumnViewHandle instance)
	{
		return Observable.Create((IObserver<GtkColumnViewSignalStructs.ActivateSignal> obs) =>
		{
			GtkColumnViewSignalDelegates.Activate handler = (GtkColumnViewHandle self, uint position, IntPtr user_data) =>
			{
				...
				var signalStruct = new GtkColumnViewSignalStructs.ActivateSignal()
				{
...
public static class GtkColumnViewSignalStructs
{

public struct ActivateSignal
{
	public GtkColumnViewHandle Self;
