...
public static class GtkPrintJobSignalExtensions
{
	...
	public static IObservable<GtkPrintJobSignalStructs.StatusChangedSignal> Signal_StatusChanged(this GtkPrintJobHandle instance)
	{
		return Observable.Create((IObserver<GtkPrintJobSignalStructs.StatusChangedSignal> obs) =>
		{
			GtkPrintJobSignalDelegates.StatusChanged handler = (GtkPrintJobHandle self, IntPtr user_data) =>
			{
				...
				var signalStruct = new GtkPrintJobSignalStructs.StatusChangedSignal()
				{
...
public static class GtkPrintJobSignalStructs
{

public struct StatusChangedSignal
{
	public GtkPrintJobHandle Self;
