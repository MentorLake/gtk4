...
internal class GlobalFunctionExterns
{
	...
	[DllImport(Libraries.GObject)]
	internal static extern void g_signal_override_class_handler(string signal_name, GType instance_type, GCallback class_handler);
	[DllImport(Libraries.GObject)]
	...
	[DllImport(Libraries.GObject)]
	internal static extern uint g_signal_new_class_handler(string signal_name, GType itype, GSignalFlags signal_flags, GCallback class_handler, GSignalAccumulator accumulator, IntPtr accu_data, GSignalCMarshaller c_marshaller, GType return_type, uint n_params, IntPtr @__arglist);
	[DllImport(Libraries.GObject)]
	...
	[DllImport(Libraries.GObject)]
	internal static extern ulong g_signal_connect_object(GTypeInstanceHandle instance, string detailed_signal, GCallback c_handler, GObjectHandle gobject, GConnectFlags connect_flags);
	[DllImport(Libraries.GObject)]
