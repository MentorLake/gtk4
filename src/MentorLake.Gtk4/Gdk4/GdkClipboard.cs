...
public static class GdkClipboardSignalExtensions
{
	...
	public static IObservable<GdkClipboardSignalStructs.ChangedSignal> Signal_Changed(this GdkClipboardHandle instance)
	{
		return Observable.Create((IObserver<GdkClipboardSignalStructs.ChangedSignal> obs) =>
		{
			GdkClipboardSignalDelegates.Changed handler = (GdkClipboardHandle self, IntPtr user_data) =>
			{
				...
				var signalStruct = new GdkClipboardSignalStructs.ChangedSignal()
				{
...
public static class GdkClipboardSignalStructs
{

public struct ChangedSignal
{
	public GdkClipboardHandle Self;
