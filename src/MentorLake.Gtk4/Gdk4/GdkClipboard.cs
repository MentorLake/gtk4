...
{
	public static GdkClipboardSignal Changed = new("changed");
}
...
public static class GdkClipboardHandleExtensions
{
	...
	public static GdkClipboardHandle Connect(this GdkClipboardHandle instance, GdkClipboardSignal signal, GCallback c_handler)
	{
