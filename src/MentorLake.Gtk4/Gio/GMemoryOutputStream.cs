...
{
	public static GMemoryOutputStreamHandle New(IntPtr data, UIntPtr size, GReallocFunc realloc_function, GDestroyNotify destroy_function)
	{
...
public static class GMemoryOutputStreamHandleExtensions
{
	...
	public static UIntPtr GetDataSize(this GMemoryOutputStreamHandle ostream)
	{
		return GMemoryOutputStreamExterns.g_memory_output_stream_get_data_size(ostream);
	}

	public static UIntPtr GetSize(this GMemoryOutputStreamHandle ostream)
	{
...
internal class GMemoryOutputStreamExterns
{
	...
	internal static extern GMemoryOutputStreamHandle g_memory_output_stream_new(IntPtr data, UIntPtr size, GReallocFunc realloc_function, GDestroyNotify destroy_function);
	...
	[DllImport(Libraries.Gio)]
	internal static extern UIntPtr g_memory_output_stream_get_data_size(GMemoryOutputStreamHandle ostream);

	[DllImport(Libraries.Gio)]
	internal static extern UIntPtr g_memory_output_stream_get_size(GMemoryOutputStreamHandle ostream);
