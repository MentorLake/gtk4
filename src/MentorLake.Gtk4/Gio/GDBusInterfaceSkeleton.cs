...
public class GDBusInterfaceSkeletonHandle : GObjectHandle
{
}

public class GDBusInterfaceSkeletonSignal
{
	public string Value { get; set; }
	public GDBusInterfaceSkeletonSignal(string value) => Value = value;
}
